...
class Settings(BaseSettings):
    ...
    SERVICE_PORT: int = 5173 # 开发阶段建议是由固定值，随机的URL安全文本字符串
    ...
    LOCAL_STORAGE_DIRECTORY: str = "/home/ubuntu/git_dev_code/VisionTraceStudio/images" # 本地存储目录
    REMOTE_BACKUP_DIRECTORY: str = "" # 远程数据备份目录
    REMOTE_SHARED_DIRECTORY: str = "" # 共享数据目录
    ...
    model_config = ConfigDict(extra='forbid',env_file=".env",from_attributes =True)
    # class Config:
