...
class client_file_picker(DisableableElement, component='client_file_picker.js'):
    ...
    def __init__(self, *,
        ...
        self._props['hide-upload-btn'] = True
        self.baseurl = f'http://{settings.API_URL}/api/v1/datasets/upload_files'
        self._props['url'] = self.baseurl
